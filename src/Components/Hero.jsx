...
export default function Hero() {
  return (
    <motion.div
      className="mt-10 sm:mt-40 hero" // Adjusted top margin for smaller screens
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
    >
      <div className="container grid items-center justify-center grid-cols-1 px-4 mx-auto my-16 sm:grid-cols-2"> {/* Adjusted grid columns for smaller screens */}
        {/* left side */}
        <motion.div
        ...
        >
          <div className="img-container">
            <motion.img
              src="./hero-img.png"
              alt="crypto"
              className="max-w-full mx-auto sm:max-w-200" // Adjusted max width for smaller screens
